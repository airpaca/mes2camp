 ...
 * http://stackoverflow.com/questions/12591042/parameters-option-in-the-postgis-geojson-php-script
 * Modified: transform -> st_transform
 */
...
$conn = pg_connect("dbname='' user='' password='' host='localhost'");
if (!$conn) {
